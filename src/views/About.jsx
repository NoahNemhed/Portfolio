    ...
    return (
        <>
            <div className={"flex flex-col text-md text-left items-center max-w-[1000px] pt-16 pb-32 w-full"}>
                ...
                Hello! I'm Noah, a passionate Webdeloper based in Malmö, Sweden. In 2021, a friend introduced me to the world of programming, and since then, I've been captivated by the endless possibilities and creative freedom it offers.
                
                </p>
                <p className={"dark-slate w-full mb-4 leading-7"}>
                Starting with Powershell and VBA, I've progressed rapidly, expanding my skill set to include Java, JavaScript, React, MongoDB, and numerous other tools. Currently, I am actively engaged in learning new frameworks and staying updated on emerging technologies.
                </p>
                <p className={"dark-slate w-full mb-4 leading-7"}>
                ...
                <ul className={"dark-slate font-monospace text-[14px] grid grid-cols-2 gap-2 bullet-list w-full "}>
                    ...
                    <li className="hover-accent">React & Next.js</li>
                    <li className="hover-accent">Node.js & Express</li>
                    <li className="hover-accent">Redux Toolkit</li>
                    <li className="hover-accent">MongoDB & Mongoose</li>
                </ul>
            </div>
        </>
    )
